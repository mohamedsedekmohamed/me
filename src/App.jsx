...
<Pro/>
    ...
    <div  ref={section4Ref} className={`relative  h-fit  flex flex-col items-center justify-center  text-white ${darkMode?"bg-black ":"bg-gradient-to-b  from-white to-yellow-800 "} `}>
    <Footer  />
    </div>
