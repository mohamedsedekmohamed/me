...
useEffect(() => {
  ...
  return (
    ...
    <div   className={`sticky top-0 h-screen flex flex-col items-center justify-center ${darkMode?"bg-gradient-to-t  from-black to-white" :"bg-gradient-to-t  from-green-800 to-white"}  `}>
    <Home   />
    </div>
